          ...
          <div className="col-lg-5 mt-30">
            <div className="token__content wow fadeInLeft">
              ...
              <div className="token__info mt-40">
                ...
                <p>
                Our token distribution is structured to support long-term project growth and ecosystem sustainability. Funds are allocated across development, partnerships, marketing, operations, and legal compliance to ensure transparency and stability for the platform.
                </p>
